...
void showbmpdatei (char* p_name)
  {
  cbmpdatei bilddatei (p_name);
  cxscreen bildschirm ("BMP Bild", bilddatei.xanz*2, bilddatei.yanz*2);
//  cbmpdatei doppelbild ("doublerim.bmp", bilddatei.xanz*2, bilddatei.yanz*2);
//  doubleshit (bilddatei, doppelbild);
//  bildschirm.putscreen (doppelbild, 0, 0);
  doubleshit (bilddatei, bildschirm);
  bildschirm.flush ();
//  doublepic (bilddatei, doppelbild);
//  bildschirm.putscreen (doppelbild, 0, 0);
  doublepic (bilddatei, bildschirm);
  bildschirm.flush ();
  }
