...
void visualisierekantenmodell (cbasis3liste& pbliste, cbasis3 pspiegelbasis)
  ...
  ckoerper* bewkugel= new ckoerper (new cskugel, new cparakugel_mercator_z (0, 0), new cbegrkeine, textur1, 0, real (0.1)*kzoom);
...
void visualisierefundamentalbereiche (cbasis3liste& pbliste, cbasis3 pspiegelbasis)
  ...
  welt.addkoerper (new ckoerper (new cskugel, new cparakugel_mercator_z (0, 0), new cbegrkeine, textur1, 0, real (1.2)*kzoom));
