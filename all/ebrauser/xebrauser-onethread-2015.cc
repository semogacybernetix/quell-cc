// Version onethread 2015

// Version 2015.10.02-08:39
...
struct cvier
  ...
  void setgenbrett (signed long* pstandort, signed long* pbrett)
    {
    memset (&*pbrett, 0, 64*sizeof (*pbrett));
    pbrett[pstandort[1]]= sgn (figurnrfb[1]);
    pbrett[pstandort[2]]= sgn (figurnrfb[2]);
    pbrett[pstandort[3]]= sgn (figurnrfb[3]);
    pbrett[pstandort[4]]= sgn (figurnrfb[4]);
    }
...
void analysiere ()
  ...
  signed long bewanz= setendpos11 ();
  signed long sum= 0;
  signed long ebene= 0;
    do
    {
