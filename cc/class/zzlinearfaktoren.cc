...
// Fallunterscheidung, ohne Division
...
// enthält auch buch mit q statt v, keine Fallunterscheidung, Division durch 0 muss abefangen werden
...
/*
  printtext ("-------------------------------- Koeffizienten quartische Gleichung -------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("a           ", a, 0);
  printvektor2komplex ("b           ", b, 0);
  printvektor2komplex ("c           ", c, 0);
  ...
  printtext ("-------------------------------- Koeffizienten reduzierte quartische Gleichung ------------------------------------------------------------------------------------------------------------\n");
  ...
  printtext ("-------------------------------- Lösungen kubische Resolvente diffp ------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("z1          ", z1, 0);
  printvektor2komplex ("z2          ", z2, 0);
  printvektor2komplex ("z3          ", z3, 0);
  printtext ("\n");
  ...
  printtext ("-------------------------------- quartische Gleichung Diffpu --------------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("x1          ", y1 - a4, 0);
  printvektor2komplex ("x2          ", y2 - a4, 0);
  printvektor2komplex ("x3          ", y3 - a4, 0);
  printvektor2komplex ("x4          ", y4 - a4, 0);
  printtext ("\n");

  quartischreduziertbuchu (p, q, r, y1, y2, y3, y4);

  printtext ("-------------------------------- quartische Gleichung buchu --------------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("x1          ", y1 - a4, 0);
  printvektor2komplex ("x2          ", y2 - a4, 0);
  printvektor2komplex ("x3          ", y3 - a4, 0);
  printvektor2komplex ("x4          ", y4 - a4, 0);
  ...
  printtext ("-------------------------------- quartische Gleichung buchv --------------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("x1          ", y1 - a4, 0);
  printvektor2komplex ("x2          ", y2 - a4, 0);
  printvektor2komplex ("x3          ", y3 - a4, 0);
  printvektor2komplex ("x4          ", y4 - a4, 0);
  ...
  printtext ("-------------------------------- quartische Gleichung buchf --------------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("x1          ", y1 - a4, 0);
  printvektor2komplex ("x2          ", y2 - a4, 0);
  printvektor2komplex ("x3          ", y3 - a4, 0);
  printvektor2komplex ("x4          ", y4 - a4, 0);
  ...
  printtext ("-------------------------------- quartische Gleichung pdfw2 --------------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("x1          ", y1 - a4, 0);
  printvektor2komplex ("x2          ", y2 - a4, 0);
  printvektor2komplex ("x3          ", y3 - a4, 0);
  printvektor2komplex ("x4          ", y4 - a4, 0);
  ...
  printtext ("-------------------------------- quartische Gleichung Lagrange ------------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("x1          ", y1 - a4, 0);
  printvektor2komplex ("x2          ", y2 - a4, 0);
  printvektor2komplex ("x3          ", y3 - a4, 0);
  printvektor2komplex ("x4          ", y4 - a4, 0);
  ...
  printtext ("-------------------------------- quartische Gleichung Buch3 --------------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("x1          ", y1 - a4, 0);
  printvektor2komplex ("x2          ", y2 - a4, 0);
  printvektor2komplex ("x3          ", y3 - a4, 0);
  printvektor2komplex ("x4          ", y4 - a4, 0);
  ...
  printtext ("-------------------------------- quartische Gleichung PDFw23 -------------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("x1          ", y1 - a4, 0);
  printvektor2komplex ("x2          ", y2 - a4, 0);
  printvektor2komplex ("x3          ", y3 - a4, 0);
  printvektor2komplex ("x4          ", y4 - a4, 0);
  ...
  printtext ("-------------------------------- quartische Gleichung Lagrange3 ----------------------------------------------------------------------------------------------------------------------------\n");
  printvektor2komplex ("x1          ", y1 - a4, 0);
  printvektor2komplex ("x2          ", y2 - a4, 0);
  printvektor2komplex ("x3          ", y3 - a4, 0);
  printvektor2komplex ("x4          ", y4 - a4, 0);
