...
void fibo128 ()
  ...
  char zahl2[128];
  char zahl3[128];
  __float128 gs= 0.5 + sqrtq (1.25);

  for (__float128 glauf= -10; glauf <= 30; glauf++)
    {
    __float128 l1= powq (gs, glauf);
    __float128 l2= powq (-gs, -glauf);
    __float128 lucas= l1 + l2;
    quadmath_snprintf (zahl0, sizeof zahl0, "%5.0Qf", glauf);
    quadmath_snprintf (zahl1, sizeof zahl1, "%50.30Qf", lucas);
    quadmath_snprintf (zahl2, sizeof zahl2, "%50.30Qf", l1);
    quadmath_snprintf (zahl3, sizeof zahl3, "%50.30Qf", l2);
